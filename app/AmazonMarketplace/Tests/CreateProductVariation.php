...
$productDescriptionData
  ...
  ->setMfrPartNumber($_GET['ParentProductId'])
...
$clothing->getVariationData()
  ->setVariationTheme(MwseXmlProductDataClothingVariationData::VARIATION_THEME_COLOR_SIZE)
  ->setColor("Blue")
  ->setSize("S")
  ->setParentage(MwseXmlProductDataClothingVariationData::PARENTAGE_CHILD);

$product->setProductData($clothing);
$product->setOperationType("Update");
