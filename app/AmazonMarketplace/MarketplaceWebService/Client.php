 ...
 */
require_once (__DIR__ . '/../MarketplaceWebService/Interface.php');
...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
  ...
  public function submitFeed($request)
  {
    ...
    require_once (__DIR__ . '/../MarketplaceWebService/Model/SubmitFeedResponse.php');
  ...
  public function getFeedSubmissionResult($request)
  {
    ...
    require_once (__DIR__ . '/Model/GetFeedSubmissionResultResponse.php');
  ...
  private function performRequest($action, array $converted, $dataHandle = null) {
    ...
    require_once(__DIR__ . '/../MarketplaceWebService/Model/ResponseHeaderMetadata.php');
